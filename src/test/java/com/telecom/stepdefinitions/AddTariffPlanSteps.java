...
public void user_Need_to_fill_up_the_fields() {
    ...
    driver.findElement(By.xpath("(//input[@type='text'])[3]")).sendKeys("25");
    driver.findElement(By.xpath("(//input[@type='text'])[4]")).sendKeys("100");
    driver.findElement(By.xpath("(//input[@type='text'])[5]")).sendKeys("5");
    driver.findElement(By.xpath("(//input[@type='text'])[6]")).sendKeys("4");
    driver.findElement(By.xpath("(//input[@type='text'])[7]")).sendKeys("3");   
}
...
public void user_Verify_the_customer_Id_is_generated() {
   String S1=driver.findElement(By.xpath("//h2[text()='Congratulation you add Tariff Plan']")).getText();
...
public void user_Need_to_fill_up_the_fields_by_D_List(Integer int1,DataTable datas) {
   ...
   driver.findElement(By.xpath("(//input[@type='text'])[1]")).sendKeys(details.get(0));
   driver.findElement(By.xpath("(//input[@type='text'])[2]")).sendKeys(details.get(1));
   driver.findElement(By.xpath("(//input[@type='text'])[3]")).sendKeys(details.get(2));
   driver.findElement(By.xpath("(//input[@type='text'])[4]")).sendKeys(details.get(3));
   driver.findElement(By.xpath("(//input[@type='text'])[5]")).sendKeys(details.get(4));
   driver.findElement(By.xpath("(//input[@type='text'])[6]")).sendKeys(details.get(5));
   driver.findElement(By.xpath("(//input[@type='text'])[7]")).sendKeys(details.get(6));   
}
